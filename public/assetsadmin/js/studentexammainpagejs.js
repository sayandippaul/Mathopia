
    {
        ...
        var object =
        {
            ...
            "totalquestions": 20,
            "totaltopics": ["math", "physics", "chemistry", "geography", "history"],
            "time": 120,
            "class": "11",
            "set": "xi2",
            ...
            "allquestions": [
                ...
                },
                {
                    ...
                    "type": "d",
                    "topic": "math",
                    "body": "What is the value of pi (π) to two decimal places?",
                    "noofoptions": 2,
                    "oc": 1,
                    "op1": "3.14",
                    "op2": "3.16",
                ...
                },
                {
                    ...
                    "type": "n",
                    "topic": "math",
                    "body": "What is the result of 2 + 2 * 2?",
                    "noofoptions": 0,
                    "oc": 1,
                    "image": "q0"
                },
                ...
                // Physics
                {
                    ...
                    "type": "s",
                    "topic": "physics",
                    "body": "What is the speed of light in a vacuum?",
                    "noofoptions": 2,
                    "oc": 1,
                    "op1": "299,792,458 m/s",
                    "op2": "300,000,000 m/s",
                ...
                },
                {
                    ...
                    "type": "d",
                    "topic": "physics",
                    "body": "What is the state of matter of steam?",
                    "noofoptions": 3,
                    "oc": 1,
                    "op1": "gas",
                    "op2": "liquid",
                ...
                },
                {
                    ...
                    "type": "s",
                    "topic": "geography",
                    "body": "Which continent is the largest by land area?",
                    "noofoptions": 4,
                    "oc": 1,
                    "op1": "Asia",
                    "op2": "Africa",
                ...
                },
                {
                    ...
                    "type": "s",
                    "topic": "geography",
                    "body": "What is the highest mountain in the world?",
                    "noofoptions": 2,
                    "oc": 1,
                    "op1": "Mount Everest",
                    "op2": "K2",
                ...
                },
                {
                    ...
                    "type": "s",
                    "topic": "geography",
                    "body": "Which country is known as the 'Land of the Rising Sun'?",
                    "noofoptions": 2,
                    "oc": 1,
                    "op1": "Japan",
                    "op2": "China",
                ...
                },
                {
                    ...
                    "type": "s",
                    "topic": "geography",
                    "body": "Which ocean is the largest by surface area?",
                    "noofoptions": 4,
                    "oc": 1,
                    "op1": "Pacific Ocean",
                    "op2": "Atlantic Ocean",
                ...
                },
                {
                    ...
                    "type": "s",
                    "topic": "history",
                    "body": "In which year did World War II end?",
                    "noofoptions": 2,
                    "oc": 1,
                    "op1": "1945",
                    "op2": "1918",
                ...
                },
                {
                    ...
                    "type": "s",
                    "topic": "history",
                    "body": "Who was the first female Prime Minister of the United Kingdom?",
                    "noofoptions": 3,
                    "oc": 1,
                    "op1": "Margaret Thatcher",
                    "op2": "Theresa May",
                    "op3": "Indira Gandhi",
                    "image": "q0"
                },
                {
                    ...
                    "type": "s",
                    "topic": "history",
                    "body": "In which city did the Renaissance begin?",
                    "noofoptions": 2,
                    "oc": 1,
                    "op1": "Florence",
                    "op2": "Rome",
                ...
                },
                {
                    ...
                    "type": "s",
                    "topic": "history",
                    "body": "Who wrote 'The Communist Manifesto'?",
                    "noofoptions": 2,
                    "oc": 1,
                    "op1": "Karl Marx",
                    "op2": "Friedrich Engels",
                    "image": "q0"
                }
            ]
        ...
        var totaltopics = object.totaltopics.length;
       ...
       `;
            ...
            topicsprint = topicsprint + ` <li  onclick="all1()"style="padding:5px" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom"
        ...
        function printquestionnumbers() {
            ...
            for (var i = 1; i <= object.totaltopics.length; i++) {
                var c = 0; temp1 = "";
                for (var j = 0; j < object.allquestions.length; j++) {

                    if (object.allquestions[j].topic == object.totaltopics[i - 1]) {
                        c++;
                        var w = parseInt(j + 1);
                        if (c % 4 == 0) {
        ...
        // <input class="form-check-input" value="`+j+`" onclick="gett(`+j+`)" id="opt`+j+`" type="radio"
        //                         name="flexRadioDefault" id="flexRadioDefault2">
        //                     <label class="form-check-label" for="flexRadioDefault2">
        //                         <strong id="op`+j+`"></strong>
        //                     </label>
...
// this is after clicking function of question number
    function ge(p) {
...
// clear function
    function clea() {
        ...
        document.getElementById(no).style.backgroundColor = "#ff8080";
        // console.log(object.allquestions[no-1].type);

        if (object.allquestions[no-1].type == "n") {
        ...
        for (var i = 1; i <= object.allquestions[no - 1].noofoptions; i++) {
            document.getElementById("clear").disabled = true;
            document.getElementById("clear").style.backgroundColor = "grey";
...
//after clicking an option  
    function gett(p) {
        if (object.allquestions[no - 1].type == "s") {
            user = p;
        ...
        else if (object.allquestions[no - 1].type == "d") {
            var answer = String(ansarr[no - 1].ans);
            if (answer.includes(0) == true) {
                answer = String(user);
                answer = answer.replace('0', '');
                // console.log("answer"+answer);
            }
            if (answer.includes(p) == false) {
                answer = answer + p;
                // user=answer;
                user = answer.split("").sort().join("");
        ...
        else if (object.allquestions[no - 1].type == "n") {
...
// question show function
    function show(i) {
        ...
        for (var j = 1; j <= object.allquestions[i - 1].noofoptions; j++) {
            var w = "op" + j;
            // console.log(w);
        ...
        document.getElementById("qno").innerHTML = object.allquestions[i - 1].no;
        document.getElementById("qshow").innerHTML = object.allquestions[i - 1].body;
        if (object.allquestions[i - 1].type == "s") {

            document.getElementById("qtype").innerHTML = "SINGLE OPTION CORRECT";
        }
        else if (object.allquestions[i - 1].type == "d") {
            document.getElementById("qtype").innerHTML = "ONE OR MORE THAN ONE OPTION CORRECT";

        } else if (object.allquestions[i - 1].type == "n") {
            document.getElementById("qtype").innerHTML = "NUMERICAL ANSWER TYPE";
        ...
        subshow(object.allquestions[i - 1].topic);
...
// after clicking top head subject
    function gotohead(q) {
        ...
        for (var i = 0; i < object.allquestions.length; i++) {
            if (object.allquestions[i].topic == object.totaltopics[q - 1]) {
